...
register(
    id="MyModCartPole-v0",
    entry_point="gymnasium.envs.classic_control.mycartpole:MyModCartPoleEnv",
...
register(
    id='MyModAcrobot-v0',
    entry_point='gymnasium.envs.classic_control.myacrobot:MyModAcrobotEnv',
    kwargs={'case':0}
)
register(
    id='MyModAcrobot-v1',
...
register(
    id='MyModLunarLander-v0',
    entry_point='gymnasium.envs.box2d.mylunar_lander:MyModLunarLander',
    kwargs={'case':0}
)
register(
    id='MyModLunarLander-v1',
    entry_point='gymnasium.envs.box2d.mylunar_lander:MyModLunarLander',
    kwargs={'case':1}
)
register(
    id='MyModLunarLander-v2',
    entry_point='gymnasium.envs.box2d.mylunar_lander:MyModLunarLander',
    kwargs={'case':2}
)
register(
    id='MyModLunarLander-v3',
    entry_point='gymnasium.envs.box2d.mylunar_lander:MyModLunarLander',
    kwargs={'case':3}
)
register(
    id='MyModLunarLander-v4',
    entry_point='gymnasium.envs.box2d.mylunar_lander:MyModLunarLander',
    kwargs={'case':4}
)
