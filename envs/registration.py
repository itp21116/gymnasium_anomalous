...
@overload
def make(id: Literal["MyModCartPole-v0", "MyModCartPole-v1", "MyModCartPole-v2", "MyModCartPole-v3", "MyModCartPole-v4"], **kwargs) -> Env[np.ndarray, Union[np.ndarray, int]]: ...
@overload
...
@overload
def make(id: Literal["MyModAcrobot-v0", "MyModAcrobot-v1", "MyModAcrobot-v2", "MyModAcrobot-v3", "MyModAcrobot-v4"], **kwargs) -> Env[np.ndarray, Union[np.ndarray, int]]: ...
