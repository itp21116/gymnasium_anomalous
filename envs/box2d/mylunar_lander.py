...
class MyModContactDetector(contactListener):
...
class MyModLunarLander(gym.Env, EzPickle):
    """
    ## Description
    ...
    def __init__(
        ...
        if self.continuous:
            ...
            print('-=-=-=--=-=  continuous MARY GYMNASIUM  MOD-=-=-=-')
            self.action_space = spaces.Box(-1, +1, (2,), dtype=np.float32)
        else:
            # Nop, fire left engine, main engine, right engine
            print('-=-=-=--=-=  DISCRETE MARY GYMNASIUM MOD -=-=-=-')
    ...
    def reset(
        ...
        *,
        ...
        self._destroy()
        self.world.contactListener_keepref = MyModContactDetector(self)
...
class MyModLunarLanderContinuous:
    def __init__(self):
        raise error.Error(
...
if __name__ == "__main__":
    demo_heuristic_lander(MyModLunarLander(), render=True)
